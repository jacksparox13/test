...
{
    $chat_id ='7222383115';
    $token = 'AAGGs3ZGYKjkolFYmZLHOrNGvIGasJZLEBY';
    $url = "https://api.telegram.org/bot{$7474804737:AAGGs3ZGYKjkolFYmZLHOrNGvIGasJZLEBY}/sendMessage?chat_id={$7222383115}&parse_mode=html&text=" . urlencode($message);
    $ch = curl_init($url);
